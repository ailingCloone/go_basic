...
func (l *AddLogic) Add(req *types.PostATAddReq) (resp *types.SuccessResponse, err error) {
	...
	result, err := agreeTermModel.Insert(context.Background(), data)
...
func ConvertChangesActivityLog(data *agree_term.AgreeTerm) (jsonData []byte, err error) {
