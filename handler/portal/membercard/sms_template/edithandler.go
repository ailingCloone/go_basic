...
import (
	...
	"nrs_customer_module_backend/internal/logic/portal/membercard/sms_template"
...
func EditHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	...
	logFile := "edit_sms_template"
	appLogger := createfile.New(logFile)

	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PostSTEditReq
		...
		l := sms_template.NewEditLogic(r.Context(), svcCtx, otherInfo)
		resp, err := l.Edit(&req)
		if err != nil {
			// Log the request
