...
import (
	...
	"nrs_customer_module_backend/internal/logic/portal/membercard/setting"
...
func EditHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	...
	logFile := "edit_card_setting"
	appLogger := createfile.New(logFile)

	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PostCardSettingEditReq
		...
		l := setting.NewEditLogic(r.Context(), svcCtx, otherInfo)
		resp, err := l.Edit(&req)
		if err != nil {
			// Log the request
