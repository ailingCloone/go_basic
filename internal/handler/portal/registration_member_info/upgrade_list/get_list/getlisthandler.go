...
import (
	...
	"nrs_customer_module_backend/internal/logic/portal/registration_member_info/upgrade_list/get_list"
...
func GetListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	...
	logFile := "registration_member_info_upgrade_list_get_list"
