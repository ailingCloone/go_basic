...
import (
	...
	"nrs_customer_module_backend/internal/logic/app/card/get_list"
...
func GetListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	logFile := "card_get_list"
	appLogger := createfile.New(logFile)

	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PostCardGetListReq
		...
		if err != nil {
			...
			info := map[string]interface{}{
				"source_name": "type",
				"source_id":   req.Type,
				"message":     "This type is invalid. Please check again.",
			}
