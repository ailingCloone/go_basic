...
import (
	...
	"nrs_customer_module_backend/internal/logic/app/password"
...
func ForgotPasswordHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	...
	logFile := "forgot_password"
	appLogger := createfile.New(logFile)

	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PostForgotPasswordAppReq
		...
		l := password.NewForgotPasswordLogic(r.Context(), svcCtx, otherInfo)
